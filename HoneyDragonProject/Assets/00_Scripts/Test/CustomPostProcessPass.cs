...
public class CustomPostProcessPass : ScriptableRenderPass
{
    ...
    private BenDayBloomComponent m_bloomEffect;

    public CustomPostProcessPass(Material bloomMaterial, Material compositeMaterai)
    {
        m_bloomMaterial = bloomMaterial;
        m_compositeMaterial = compositeMaterai;
    ...
    public override void Execute(ScriptableRenderContext context, ref RenderingData renderingData)
    {
        ...
        m_bloomEffect = stack.GetComponent<BenDayBloomComponent>();
    ...
    private void SetupBloom(CommandBuffer cmd, RTHandle source)
    {
        ...
        float thresholdKnee = threshold * 0.5f; // Hardcore Soft knee
