            ...
            for (int i = 0; i < m_TextInfo.wordCount; i++)
            {
                ...
                for (int j = 0; j < wInfo.characterCount; j++)
                {
                    ...
                    if (isBeginRegion == false && isCharacterVisible)
                    {
                        ...
                        //Logger.Log("Start Word Region at [" + currentCharInfo.character + "]");
                        ...
                        if (wInfo.characterCount == 1)
                        {
                            ...
                            //Logger.Log("End Word Region at [" + currentCharInfo.character + "]");
                        }
                    }
                ...
                //Logger.Log(wInfo.GetWord(m_TextMeshPro.textInfo.characterInfo));
            }
