    ...
    public class Benchmark01_UGUI : MonoBehaviour
    {
        ...
        IEnumerator Start()
        {
            ...
            if (BenchmarkType == 0) // TextMesh Pro Component
            {
                ...
                //m_textMeshPro.font = Util.ResourceCache.Load("Fonts & Materials/Anton SDF", typeof(TextMeshProFont)) as TextMeshProFont; // Make sure the Anton SDF exists before calling this...           
                //m_textMeshPro.fontSharedMaterial = Util.ResourceCache.Load("Fonts & Materials/Anton SDF", typeof(Material)) as Material; // Same as above make sure this material exists.
            ...
            else if (BenchmarkType == 1) // TextMesh
            {
                ...
                {
                    //m_textMesh.font = Util.ResourceCache.Load("Fonts/ARIAL", typeof(Font)) as Font;
                    //m_textMesh.renderer.sharedMaterial = m_textMesh.font.material;
                }
