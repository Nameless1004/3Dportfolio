        ...
        void Start()
        {
            ...
            for (int i = MinPointSize; i <= MaxPointSize; i += Steps)
            {
                if (SpawnType == 0)
                {
                    ...
                    //textMeshPro.font = Util.ResourceCache.Load("Fonts & Materials/LiberationSans SDF", typeof(TextMeshProFont)) as TextMeshProFont;
                ...
                else
                {
                    ...
                    textMesh.font = Util.ResourceCache.Load("Fonts/ARIAL", typeof(Font)) as Font;
